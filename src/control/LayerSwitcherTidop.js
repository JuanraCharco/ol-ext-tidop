 ...
 */
var ol_control_LayerSwitcherTidop = class olcontrolLayerSwitcherTidop extends ol_control_Control {
  constructor(options) {
    options = options || {}
...
*/
ol_control_LayerSwitcherTidop.prototype.tip = {
  up: "up/down",
  down: "down",
  info: "informations...",
...
export default ol_control_LayerSwitcherTidop
