...
import ol_control_LayerSwitcherChameleon from '../control/LayerSwitcherChameleon.js'
 ...
 */
var ol_control_LayerShopChameleon = class olcontrolLayerShopChameleon extends ol_control_LayerSwitcherChameleon {
  constructor(options) {
    ...
    super(options);
    this.element.classList.add('ol-layer-shop-chameleon');
...
export default ol_control_LayerShopChameleon
