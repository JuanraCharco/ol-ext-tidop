 ...
 */
var ol_control_LayerSwitcherChameleon = class olcontrolLayerSwitcherChameleon extends ol_control_Control {
  constructor(options) {
    options = options || {}
    var element = ol_ext_element.create('DIV', {
      className: options.switcherClass || 'ol-layerswitcher-chameleon'
    })
    super({
      element: element,
  ...
  drawList(ul, collection) {
    ...
    function createLi(layer) {
      ...
      var layer_buttons = ol_ext_element.create('DIV', {
        className: 'ol-layerswitcher-chameleon-buttons',
        parent: li
      })

      // Content div
      var d = ol_ext_element.create('DIV', {
        className: 'li-content ' + layer.get('id'),
        parent: li
      })
...
*/
ol_control_LayerSwitcherChameleon.prototype.tip = {
  up: "up/down",
  down: "down",
  info: "informations...",
...
export default ol_control_LayerSwitcherChameleon
