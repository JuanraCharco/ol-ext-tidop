 ...
 */
var ol_control_MapZoneTidop = class olcontrolMapZoneTidop extends ol_control_Control {
  constructor(options) {
    options = options || {}
...
/** Pre-defined zones */
ol_control_MapZoneTidop.zones = {};
  
/** French overseas departments  */
ol_control_MapZoneTidop.zones.DOM = [{
  "title": "Guadeloupe",
...
ol_control_MapZoneTidop.zones.TOM = [{
...
ol_control_MapZoneTidop.zones.DOMTOM = [{
  title: 'Métropole',
  extent: [ -5.318421740712579, 41.16082274292913, 9.73284186155716, 51.21957336557702 ]
}].concat(ol_control_MapZoneTidop.zones.DOM, ol_control_MapZoneTidop.zones.TOM);

export default ol_control_MapZoneTidop
